...
class axioma_customizations extends CModule
{
    ...
    protected $eventsHandls=[
        [
            ...
            'module' => 'main',
            'class' => 'Axioma\Customizations\Events\OnBeforeProlog',
    ...
    protected $agents=[
        [
            ...
            'to' => "/local/components/axioma.customizations/",
            'is_path' => true,
        ],
    ];

    protected $tables=[
        'Axioma\Customizations\Applications\CategoriedEntitySellector\Orm\ConfigTable'
    ];
    ...
    public function __construct()
    {
        ...
        $this->MODULE_NAME = GetMessage("MODULE_AXIOMA_CUSTOMIZATIONS_NAME");
        $this->MODULE_DESCRIPTION = GetMessage("MODULE_AXIOMA_CUSTOMIZATIONS_DESCRIPTION");
        $this->PARTNER_NAME = GetMessage("MODULE_AXIOMA_CUSTOMIZATIONS_PARTNER_NAME");
        $this->PARTNER_URI = GetMessage("MODULE_AXIOMA_CUSTOMIZATIONS_PARTNER_URI");
        $this->isDev = true;
    }
