class configAddManager{
    ...
    checkEmptyFields(){
        ...
        showNotyMessage('Отсутсвуют пользовательские поля, которым можно было бы прописывать правила блокировки', () => {
    ...
    onFormSaveClick(){
        ...
        BX.ajax.runAction('troya:fiemanager.Blockings.save', {
            data: {
                fields : data
            },
    ...
    onFormDeleteClick(evt){
        showNotyMessage('Удалить правило?', () => {
            BX.ajax.runAction('troya:fiemanager.Blockings.delete', {
                data: {
