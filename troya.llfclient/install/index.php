...
class troya_llfclient extends CModule
{
    ...
    protected $eventsHandls=[
        [
            ...
            'module' => 'main',
            'class' => 'Troya\LLFClient\Pages\Identificator',
    ...
    public function __construct()
    {
        ...
        $this->MODULE_NAME = GetMessage("MODULE_TROYA_LLFCLIENT_NAME");
        $this->MODULE_DESCRIPTION = GetMessage("MODULE_TROYA_LLFCLIENT_DESCRIPTION");
        $this->PARTNER_NAME = GetMessage("MODULE_TROYA_LLFCLIENT_PARTNER_NAME");
        $this->PARTNER_URI = GetMessage("MODULE_TROYA_LLFCLIENT_PARTNER_URI");
        $this->isDev = true;
